...
// если результат есть
  ...
  // присваиваем значения переменных и закрываем соединение
						while($row = $result->fetch_assoc()) {
							...
							<a class='grid-block__item grid-block__item_active' style='background-image:url($urlimg);background-position: center center;background-repeat: no-repeat;background-size: cover;' href='$url'>
