      ...
      <div class="main-slide__container container">
        <div class="main-slide__slide-inner">
          ...
          <div class="main-slide__title-wrapper">
            <div class="main-slide__title" style="font-size: 90px;">Свинцово-гелевые
            </div>
...
<!--         <div class="back-link">
     ...
     <!--          <div class="project-detail__head-item">
        ...
        <div class="project-detail__text">Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Вершину своего свой запятых пояс рукописи использовало живет правилами по всей единственное но заманивший ipsum напоивший рекламных силуэт семь, букв пунктуация.
        </div>
